...
sections:
  - block: markdown
    content:
      title: 'Work & Results'
      subtitle: 'AI Solutions Shipped to Production'
      text: |-
        From academic research to industry innovation—10+ years of building AI systems deployed at scale.
    design:
      columns: '1'
      ...
      text: |
        ...
        **10+ Years** in AI/ML | **9 Companies** | **2 Patents** | **7+ Publications**
        ...
        <div style="margin-top: 1.5rem;">
          ...
          <a href="/credentials/" class="cta-button-secondary">View Full Credentials →</a>
        </div>
